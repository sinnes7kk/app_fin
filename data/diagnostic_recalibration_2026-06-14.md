# Conviction-Weight Recalibration — 2026-06-14 23:10
...
| --- | --- | --- | --- | --- | --- | --- |
| 210 | 140 | high | tight | +0.079 | +0.035 | ❌ reject (tight_threshold_unmet (need spearman>=0.10 and lift>=0.05, got new=0.079, legacy=0.035)) |
...
| position | 85 | 57 | high | tight | -0.172 | -0.104 | ❌ |
| leap | 34 | 24 | medium | loose | -0.079 | +0.066 | ❌ |
| unknown | 79 | 54 | high | tight | +0.006 | +0.138 | ❌ |
