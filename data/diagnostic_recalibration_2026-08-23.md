# Conviction-Weight Recalibration — 2026-08-23 22:22
...
| --- | --- | --- | --- | --- | --- | --- |
| 726 | 485 | high | tight | +0.047 | +0.012 | ❌ reject (tight_threshold_unmet (need spearman>=0.10 and lift>=0.05, got new=0.047, legacy=0.012)) |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| lottery | 6 | 0 | low | loose | — | — | ❌ |
| swing | 32 | 22 | medium | loose | +0.337 | +0.436 | ❌ |
| position | 378 | 252 | high | tight | -0.078 | -0.082 | ❌ |
| leap | 154 | 104 | high | tight | +0.110 | +0.098 | ❌ |
| unknown | 157 | 106 | high | tight | -0.262 | -0.184 | ❌ |
