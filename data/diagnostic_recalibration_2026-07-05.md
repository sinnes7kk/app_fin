# Conviction-Weight Recalibration — 2026-07-05 23:02
...
| --- | --- | --- | --- | --- | --- | --- |
| 265 | 178 | high | tight | +0.057 | +0.083 | ❌ reject (tight_threshold_unmet (need spearman>=0.10 and lift>=0.05, got new=0.057, legacy=0.083)) |
...
| position | 98 | 66 | high | tight | +0.050 | +0.057 | ❌ |
| leap | 49 | 33 | medium | loose | -0.200 | +0.154 | ❌ |
| unknown | 103 | 70 | high | tight | -0.044 | +0.023 | ❌ |
