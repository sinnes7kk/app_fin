# Conviction-Weight Recalibration — 2026-09-13 23:55
...
| --- | --- | --- | --- | --- | --- | --- |
| 886 | 592 | high | tight | +0.054 | +0.011 | ❌ reject (tight_threshold_unmet (need spearman>=0.10 and lift>=0.05, got new=0.054, legacy=0.011)) |
...
| swing | 48 | 33 | medium | loose | +0.107 | +0.069 | ✅ |
| position | 457 | 305 | high | tight | -0.059 | -0.069 | ❌ |
| leap | 196 | 132 | high | tight | +0.078 | +0.087 | ❌ |
| unknown | 180 | 120 | high | tight | -0.081 | -0.165 | ❌ |

**`swing` weights:** `persistence=0.75, intensity=0.15, consistency=0.00, accel=0.11, mass=0.00, oi_change=0.00`  
