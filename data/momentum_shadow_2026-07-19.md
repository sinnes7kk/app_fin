# Momentum score — shadow head-to-head — 2026-07-19 22:53

Panel: **720 rows** joined on (as_of, ticker, direction) with a populated replay `realized_r`.
...
| --- | --- | --- | --- | --- | --- |
| `momentum_score` | 275 | +0.031 | -0.021 | -0.034 | 3 |
