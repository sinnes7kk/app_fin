# Conviction-Weight Recalibration — 2026-09-06 23:33
...
| --- | --- | --- | --- | --- | --- | --- |
| 777 | 519 | high | tight | +0.071 | +0.011 | ❌ reject (tight_threshold_unmet (need spearman>=0.10 and lift>=0.05, got new=0.071, legacy=0.011)) |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| lottery | 7 | 0 | low | loose | — | — | ❌ |
| swing | 37 | 26 | medium | loose | +0.203 | +0.193 | ✅ |
| position | 402 | 269 | high | tight | -0.039 | -0.052 | ❌ |
| leap | 166 | 112 | high | tight | +0.075 | +0.080 | ❌ |
| unknown | 166 | 111 | high | tight | -0.233 | -0.217 | ❌ |

**`swing` weights:** `persistence=0.55, intensity=0.09, consistency=0.00, accel=0.00, mass=0.04, oi_change=0.32`  
