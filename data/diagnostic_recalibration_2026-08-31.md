# Conviction-Weight Recalibration — 2026-08-31 00:14
...
| --- | --- | --- | --- | --- | --- | --- |
| 769 | 514 | high | tight | +0.061 | +0.008 | ❌ reject (tight_threshold_unmet (need spearman>=0.10 and lift>=0.05, got new=0.061, legacy=0.008)) |
...
| swing | 35 | 24 | medium | loose | +0.181 | +0.232 | ❌ |
| position | 400 | 267 | high | tight | -0.049 | -0.063 | ❌ |
| leap | 166 | 112 | high | tight | +0.075 | +0.080 | ❌ |
| unknown | 163 | 109 | high | tight | -0.238 | -0.203 | ❌ |
