# Conviction-Weight Recalibration — 2026-06-28 23:03
...
| --- | --- | --- | --- | --- | --- | --- |
| 247 | 165 | high | tight | +0.065 | +0.048 | ❌ reject (tight_threshold_unmet (need spearman>=0.10 and lift>=0.05, got new=0.065, legacy=0.048)) |
...
| position | 96 | 65 | high | tight | +0.038 | +0.049 | ❌ |
| leap | 45 | 31 | medium | loose | -0.248 | -0.024 | ❌ |
| unknown | 93 | 62 | high | tight | +0.041 | +0.137 | ❌ |
