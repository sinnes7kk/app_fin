# Conviction-Weight Recalibration — 2026-07-19 22:53
...
| --- | --- | --- | --- | --- | --- | --- |
| 282 | 189 | high | tight | -0.014 | +0.038 | ❌ reject (tight_threshold_unmet (need spearman>=0.10 and lift>=0.05, got new=-0.014, legacy=0.038)) |
...
| position | 105 | 70 | high | tight | +0.007 | +0.037 | ❌ |
| leap | 52 | 35 | medium | loose | -0.185 | +0.163 | ❌ |
| unknown | 109 | 73 | high | tight | -0.000 | -0.024 | ❌ |
