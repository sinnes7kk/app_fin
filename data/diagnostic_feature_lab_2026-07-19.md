# Feature lab — Spearman ranking — 2026-07-19 22:53
...
| `momentum_score` | 275 | +0.031 | -0.025 | 110 |
| `momentum_composite` | 275 | +0.031 | -0.025 | 110 |
| `dealer_net_delta_at_spot` | 95 | -0.030 | +0.188 | 38 |
| `gex_total` | 283 | -0.029 | +0.086 | 114 |
| `aggressor_bull_share` | 202 | +0.027 | +0.246 | 81 |
| `aggressor_net_prem_bps` | 204 | -0.017 | +0.075 | 82 |
| `directional_sweep_share` | 204 | -0.010 | +0.044 | 82 |
| `atm_iv_90d` | 283 | +0.008 | +0.037 | 114 |
| `ask_side_ratio` | 202 | +0.005 | +0.058 | 81 |
...
| `aggressor_net_prem_bps` | — | -0.43 (n=10) | +0.10 (n=74) | -0.07 (n=60) | -0.04 (n=57) |
| `directional_sweep_share` | — | +0.04 (n=10) | +0.03 (n=74) | +0.08 (n=60) | -0.12 (n=57) |
